<script lang="ts">
  ...
  import { storeDismissal } from '$lib/components/LayersAndTools/membership-notice';
...
>
  ...
  {#snippet body()}
    <div class="content">
      ...
      <p>
        <!-- Note: the linkText is intentionally not an actual link here,
            only the button below should be used. But this way we can reuse copy. -->
