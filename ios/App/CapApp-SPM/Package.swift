...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "NotnotsamuelCapacitorSwipeBack", path: "../../../node_modules/@notnotsamuel/capacitor-swipe-back"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "NotnotsamuelCapacitorSwipeBack", package: "NotnotsamuelCapacitorSwipeBack"),
