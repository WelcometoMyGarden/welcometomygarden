 ...
 * @param {Partial<User & {reference?: string, oldEmail?: string, newEmail?: string, latestSpamAlertAt?: string}>} callableProps - replicating what is passed to the createUser callable (and more)
 */
